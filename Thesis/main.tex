...
%\\\\\includegraphics[width=3cm]{Pictures/yoursignature.pdf} \\
...
This novel approach was used to aid in classification problems and compared to other oversampling techniques
}
...
\input{Thesis/Chapters/Introduction} %Set out your thesis and state your research question (5-8 pages)
\chapter{Background}
\input{Thesis/Chapters/Background}

\chapter{Literature Review}
\input{Thesis/Chapters/Literature Review}

\chapter{Theory}
\input{Thesis/Chapters/Theory}

\chapter{Methods}
\input{Thesis/Chapters/Methods} %Details of your approach (10-15 pages)
